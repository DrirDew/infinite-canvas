...
export function CanvasMinimap<TMetadata>({ nodes, viewport, viewportSize, theme, onViewportChange, nodeColor, width = 240, height = 160, style }: CanvasMinimapProps<TMetadata>) {
