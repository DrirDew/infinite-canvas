...
```bash
codex mcp add infinite-canvas -- node /path/to/infinite-canvas/packages/canvas-agent/dist/index.js mcp
```
...
```bash
claude mcp add --scope user --transport stdio infinite-canvas -- node /path/to/infinite-canvas/packages/canvas-agent/dist/index.js mcp
```
