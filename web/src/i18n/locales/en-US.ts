export default {
    ...
    auth: {
        ...
        teamHint: "Create teammate accounts so they can sign in and use the company provider. Regular users cannot open Settings. New users start at 0 credits; set how many images they can generate here.",
    ...
    usage: {
        title: "Usage",
        description: "See remaining credits and company image usage. Admins can add credits and create accounts.",
