export default {
    ...
    auth: {
        ...
        teamHint: "Create teammate accounts so they can sign in and use the company provider. Adjust credits on the Usage page.",
        addUser: "Add user",
        addTitle: "Add user",
    ...
    usage: {
        title: "Usage",
        description: "See remaining credits and company image usage. Admins can add credits.",
        creditBalance: "Credits left",
        generatedCount: "Generated",
        jobCount: "Jobs",
        ledger: "Ledger",
        emptyLedger: "No usage yet",
        reasonGenerate: "Generate",
        reasonAdjust: "Credit adjustment",
        team: "Team usage",
        teamHint: "Set how many images each teammate can generate. New users start at 0 credits.",
