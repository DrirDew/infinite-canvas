export default {
    ...
    settingsPanels: {
        ...
        model: { select: "Select model", selectChannel: "Select provider", assign: "Assign a model for {{capability}} in the provider settings", noMatch: "No matching {{capability}} models", addFirst: "Add a provider and models in Settings first", capabilities: { image: "image generation", video: "video", text: "text", audio: "audio" } },
    },
    ...
    auth: {
        description: "Sign in to use the company provider and workbench",
        username: "Username",
        password: "Password",
        ...
        contactAdmin: "Ask an admin to configure models",
        teamHint: "Create teammate accounts so they can sign in and use the company provider. Set daily image and video quotas here; used quota resets at midnight Asia/Shanghai.",
        addUser: "Add user",
        addTitle: "Add user",
        ...
        currentPasswordHint: "Enter the signed-in admin password to confirm the change",
        ...
        roleUser: "User",
        credits: "Credits",
        creditsLeftImage: "{{count}} images left today",
        creditsLeftVideo: "{{count}} videos left today",
        setQuota: "Set quota",
        creditsSaved: "Credits updated",
        adjustCreditsFailed: "Could not update credits",
        insufficientCredits: "Not enough credits",
        imageQuota: "Daily image quota",
        videoQuota: "Daily video quota",
    },
    usage: {
        title: "Usage",
        description: "See remaining daily quotas and image/video usage details.",
        tabs: {
            today: "Today",
            stats: "Usage stats",
        },
        ...
        imageTotal: "AI images",
        imageTasks: "AI image jobs",
        videoTotalDuration: "AI video duration",
        videoTasks: "AI video jobs",
        unitImages: "images",
        unitSeconds: "sec",
        taskTimes: "{{count}}",
        chartTitleImage: "Usage by AI image model (images)",
        chartTitleVideo: "Usage by AI video model (seconds)",
        breakdownTitleImage: "Image model usage and job count",
        breakdownTitleVideo: "Video model usage and job count",
        shareTitleImage: "Image model share (%)",
        shareTitleVideo: "Video model share (%)",
        channel: "Channel",
        modelType: "Model",
        model: "Model",
        imageCount: "Images",
        imageTaskCount: "Image jobs",
        videoDuration: "Video duration",
        videoTaskCount: "Video jobs",
        share: "Share",
        unknownChannel: "Unknown channel",
        time: "Time",
        imageRemaining: "Images remaining",
        videoRemaining: "Videos remaining",
        viewDetails: "View details",
        emptyToday: "No usage yet",
        userTodayTitle: "{{username}} today",
    ...
    config: {
        ...
        fileSecurity: "The export includes personal provider API keys and WebDAV credentials. Keep it secure.",
        fileSecurityAdmin: "The export includes shared-provider secrets, personal provider keys, and WebDAV credentials. Keep it secure.",
        ...
        channels: {
            description: "New providers are personal and only last for this browser session. Admins can turn on sharing in the editor to write them to the server for the whole team.",
            add: "Add provider",
            ...
            company: "Company",
            companyTencentVod: "Tencent Cloud",
            view: "View",
            serverManaged: "Credentials stay on the server",
            envCredentials: "Credentials come from server environment variables",
            sharedBadge: "Shared",
            personalBadge: "Personal",
            cannotDeleteShared: "Only an admin can delete a shared provider",
            onlyAdminCanShare: "Only an admin can share a provider",
            shared: "Provider is now shared",
            deleteFailed: "Failed to delete the shared provider",
            saveFailed: "Failed to save the shared provider",
            shareFailed: "Failed to share the provider",
        },
        preferences: {
            interface: "Interface",
        ...
        channelEditor: {
            title: "Edit provider",
            viewTitle: "View provider",
            companyTitle: "Company provider",
            name: "Provider name",
            protocol: "Protocol",
            ...
            tencentVodHint: "Personal providers still sign in the browser and disappear when the browser is closed. Sharing writes secrets to the server.",
            companyHint: "Sensitive fields stay hidden by default. Admins can click the eye icon to reveal them.",
            sharedHint: "Sensitive fields stay hidden by default. Admins can click the eye icon to reveal them; regular users cannot. Leave a masked or empty field unchanged to keep the saved value.",
            sharedSwitch: "Share with team",
            sharedSwitchHint: "When on, the provider is stored on the server for everyone. Only an admin can change this.",
            secretHidden: "Saved, not shown",
            envValue: "From environment variables",
