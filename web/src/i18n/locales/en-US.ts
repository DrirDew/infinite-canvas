export default {
    ...
    config: {
        ...
        channels: {
            ...
            company: "Company",
            companyTencentVod: "Tencent Cloud VOD",
            view: "View",
        ...
        channelEditor: {
            ...
            tencentVodHint: "Personal providers still sign in the browser. Put company credentials in server environment variables instead of this form.",
            companyHint: "This is a company provider. SecretId, SecretKey, and the VOD app ID stay on the server and are never sent to the browser.",
