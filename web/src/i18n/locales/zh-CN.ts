export default {
    ...
    settingsPanels: {
        ...
        model: { select: "选择模型", selectChannel: "选择渠道", assign: "请先在渠道里为{{capability}}指定模型", noMatch: "暂无匹配的{{capability}}模型", addFirst: "请先到配置里添加渠道和模型", capabilities: { image: "生图", video: "视频", text: "文本", audio: "音频" } },
    },
    ...
    auth: {
        ...
        loginFailed: "登录失败",
        logout: "退出登录",
        logoutUser: "退出 {{username}}",
        restoring: "正在恢复登录状态…",
        contactAdmin: "请联系管理员配置模型",
        teamHint: "创建同事账号后，对方即可登录使用公司渠道。可在此调整每日生图额度和每日生视频额度，已用量按上海时区每天零点重置。",
        addUser: "新增用户",
        addTitle: "新增用户",
        editTitle: "修改密码",
        createUser: "创建用户",
        ...
        currentPasswordHint: "请输入当前登录管理员的密码以确认修改",
        newPassword: "新密码",
        passwordChanged: "密码已更新",
        changePasswordFailed: "修改密码失败",
        cannotDeleteAdmin: "管理员账号不能删除",
        userDeleted: "已删除用户",
        deleteUserFailed: "删除用户失败",
        roleAdmin: "管理员",
        roleUser: "普通用户",
        credits: "额度",
        creditsLeftImage: "今日生图剩余 {{count}} 张",
        creditsLeftVideo: "今日生视频剩余 {{count}} 条",
        setQuota: "设置额度",
        creditsSaved: "额度已更新",
        adjustCreditsFailed: "调整额度失败",
    ...
    usage: {
        title: "使用统计",
        description: "查看各用户当日剩余额度，以及生图、生视频的用量明细。",
        tabs: {
            today: "今日使用",
            stats: "用量统计",
        },
        ...
        imageTotal: "AI 生图",
        imageTasks: "AI 生图任务数",
        videoTotalDuration: "AI 生视频总用量时长",
        videoTasks: "AI 生视频任务次数",
        unitImages: "张",
        unitSeconds: "秒",
        taskTimes: "{{count}} 次",
        chartTitleImage: "各 AI 生图模型用量详情 (张)",
        chartTitleVideo: "各 AI 生视频模型用量详情 (秒)",
        breakdownTitleImage: "各 AI 生图模型用量及任务数详情",
        breakdownTitleVideo: "各 AI 生视频模型用量及任务数详情",
        shareTitleImage: "各 AI 生图模型用量占比 (%)",
        shareTitleVideo: "各 AI 生视频模型用量占比 (%)",
        channel: "渠道",
        modelType: "模型类型",
        model: "模型",
        imageCount: "生图张数",
        imageTaskCount: "生图任务数",
        videoDuration: "生视频时长",
        videoTaskCount: "生视频任务数",
        share: "占比",
        unknownChannel: "未知渠道",
        time: "时间",
        imageRemaining: "生图剩余额度",
        videoRemaining: "生视频剩余额度",
        viewDetails: "查看详情",
        emptyToday: "还没有用户用量",
        userTodayTitle: "{{username}} 的今日用量",
        loadFailed: "加载用量失败",
    },
    home: {
        promptError: "获取提示词失败",
    ...
    config: {
        ...
        fileSecurity: "导出文件包含个人渠道 API Key 和 WebDAV 凭据，请妥善保管。",
        fileSecurityAdmin: "导出文件包含共享渠道、个人渠道密钥和 WebDAV 凭据，请妥善保管。",
        import: "导入配置",
        export: "导出配置",
        imported: "配置与用户偏好已导入",
        ...
        channels: {
            description: "新增默认是个人渠道，只存在当前浏览器会话，关闭后消失。管理员可在编辑页打开共享开关，写入服务端后团队全员可用。",
            add: "新增渠道",
            unnamed: "未命名渠道",
            ...
            company: "公司",
            companyTencentVod: "腾讯云",
            view: "查看",
            serverManaged: "密钥保存在服务器",
            envCredentials: "密钥参照服务端环境变量",
            sharedBadge: "共享",
            personalBadge: "个人",
            cannotDeleteShared: "共享渠道仅管理员可删除",
            onlyAdminCanShare: "只有管理员能将渠道设为共享",
            shared: "已设为共享渠道",
            deleteFailed: "删除共享渠道失败",
            saveFailed: "保存共享渠道失败",
            shareFailed: "设为共享失败",
        },
        preferences: {
        ...
        channelEditor: {
            ...
            secretKey: "SecretKey",
            subAppId: "点播应用 ID",
            tencentVodHint: "个人渠道仍在浏览器签名，关闭浏览器后会消失。打开共享后密钥写入服务端。",
            companyHint: "敏感配置默认隐藏。管理员可点击眼睛查看明文。",
            sharedHint: "敏感配置默认隐藏。管理员可点击眼睛查看明文；普通用户不能查看。未改掩码或留空表示不修改已保存的值。",
            sharedSwitch: "共享给团队",
            sharedSwitchHint: "打开后写入服务端，团队全员可见可用。只有管理员可以开关。",
            secretHidden: "已保存，不回显",
            envValue: "使用环境变量",
            models: "渠道模型",
