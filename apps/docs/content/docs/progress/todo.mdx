...
- Continue moving clipboard shortcuts and basic rendering such as node shells, connection layers, selection boxes, and the minimap into `@infinite-canvas/core`, then replace the legacy plugin runtime with Cordis.
