...
- Continue moving basic rendering such as node shells, connection layers, selection boxes, the minimap, and unknown-node placeholders into `@infinite-canvas/core`, then replace the legacy plugin runtime with Cordis.
