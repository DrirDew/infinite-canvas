...
- Extract `@infinite-canvas/core`, add the standalone `apps/example`, then reconnect Web through Core's public API before replacing the legacy plugin runtime with Cordis.
