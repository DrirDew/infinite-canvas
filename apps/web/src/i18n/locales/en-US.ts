export default {
    ...
    canvas: {
        ...
        plugins: { aiConfigRequired: "AI configuration is not ready. Configure a model and API key in Settings first.", interactiveTitle: "Interaction mode is active. Click to switch to Move mode.", movableTitle: "Move mode is active. Click to switch to Interaction mode.", move: "Move", interact: "Interact" },
