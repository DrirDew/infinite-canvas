...
- Team workbench backend: login, roles, server-side company image history, credits, and the usage page are in place, following the [Lightweight Team Backend Plan](/docs/progress/team-backend-plan).
