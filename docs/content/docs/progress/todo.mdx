...
- Team workbench backend: login, roles, server-side company image history, and credits are in place, following the [Lightweight Team Backend Plan](/docs/progress/team-backend-plan). Next: the usage page.
