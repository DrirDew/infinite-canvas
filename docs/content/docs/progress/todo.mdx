...
- Team workbench backend: login, admin/user roles, and admin-only Settings are in place, following the [Lightweight Team Backend Plan](/docs/progress/team-backend-plan). Next: server-side generation history and credits, then the usage page.
